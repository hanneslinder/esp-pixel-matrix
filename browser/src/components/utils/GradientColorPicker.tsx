...
export const GradientColorPicker: React.FC<Props> = ({
  ...
  return (
    <div className="p-6 max-w-[400px] rounded-xl">
      <div
        className="relative flex mb-6 h-8 rounded-lg shadow-[inset_0_0_1px_#888]"
        ref={control}
      ...
      >
        {colors.map((color, i) => (
          <div
            ...
            className={`absolute top-1/2 -translate-x-1/2 -translate-y-1/2 w-2.5 rounded border border-white shadow-[0_2px_4px_rgba(0,0,0,0.2)] ${
              i === index
