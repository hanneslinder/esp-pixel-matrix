...
export class CanvasWrapperElement extends React.Component<CanvasWrapperProps, {}> {
	...
	constructor(props: CanvasWrapperProps) {
		...
		this.unsubcribeFromMatrixPixelMessage = socket.subscribe(IncommingMessageType.MatrixPixelResponse, this.onMatrixPixelResponse);
	}
	...
	public render() {
		return <div id="canvas-wrapper" ref={this.canvasWrapperRef} />;
	}
}
