...
export type AppStateToPersist = Omit<
  AppState,
  "savedItems" | "connection" | "loadedItemId"
>;
export type StateFromRemote = Omit<
  AppState,
  "savedItems" | "connection" | "loadedItemId" | "matrix" | "tools" | "view"
>;
