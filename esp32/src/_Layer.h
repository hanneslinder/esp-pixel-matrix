...
//  * Adafruit_GFX library. No real benefit unless you don't want Bus_IO & Wire.h library
//  dependencies.
//  */
...
// /*
//  * Set the width and height of the layer buffers. This should match exactly that of your output
...
//   Layer()
//       : GFX(LAYER_WIDTH, LAYER_HEIGHT)
//   {
//   }

//   layerPixels* getPixels();

//   inline void init(MatrixPanel_I2S_DMA* disp)
//   {
...
//   void drawText(const char* buf, textPosition textPos = BOTTOM, const GFXfont* f = NULL,
//       uint16_t color = 0xffff, uint8_t size = 1, int xadjust = 0, int yadjust = 0,
//       int align = 1); // 128,128,128 RGB @ bottom row by default
...
// void Stack(MatrixPanel_I2S_DMA* disp, const Layer& _bgLayer, const Layer& _fgLayer,
//     bool writeToBgLayer = false);
// void Siloette(MatrixPanel_I2S_DMA* disp, const Layer& _bgLayer, const Layer& _fgLayer);
// void Blend(
//     MatrixPanel_I2S_DMA* disp, const Layer& _bgLayer, const Layer& _fgLayer, uint8_t ratio =
//     127);
// } // namespace LayerCompositor
